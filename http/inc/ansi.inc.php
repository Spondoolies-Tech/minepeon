 ...
 * https://github.com/sensiolabs/ansi-to-html/blob/master/SensioLabs/AnsiConverter/AnsiToHtmlConverter.php
 */
$ansi = array(
	'30' =>  'black',
	'31' =>  'red',
...
*/
$ansi = new AnsiToHtmlConverter($inline_colors);
...
class AnsiToHtmlConverter
{
    ...
    public function __construct($inline_colors, $inlineStyles = true, $charset = 'UTF-8')
    {
