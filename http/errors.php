<?php
// CREATED: 12/03/2014, from sw-upgrade-errors and man curl.",
// I made some small changes where variables were used
//
...
204 => "Cannot mount /mnt/[sd/mmc]-boot.",
205 => "Cannot find /mnt/[sd|mmc]-boot/uImage.",
206 => "<does not exist>",
207 => "shar file has bad signature.",
